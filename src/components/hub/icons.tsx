...
export function BookIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M4 5.2c1.6-.9 3.6-1.2 5-.9 1 .2 1.7.6 2 .9v13.6c-.5-.4-1.2-.8-2-1-1.4-.3-3.4 0-5 .9V5.2Z" />
      <path d="M20 5.2c-1.6-.9-3.6-1.2-5-.9-1 .2-1.7.6-2 .9v13.6c.5-.4 1.2-.8 2-1 1.4-.3 3.4 0 5 .9V5.2Z" />
    </svg>
  );
}
...
export function ImageIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M4 16.5 9 12l3.2 3 4-4.5 4.3 5.5" />
    </svg>
  );
}
